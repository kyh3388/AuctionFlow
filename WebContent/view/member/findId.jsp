			...
			<form action="${pageContext.request.contextPath}/api/auctionFlow/member/findId" method="post" class="find-id-form">
				...
				<div class="find-id-method">
					...
					<label for="findTypePhone" class="find-id-radio-label">
						...
						<input
							type="radio" id="findTypePhone" name="FIND_TYPE"
							value="PHONE" class="find-id-radio"
							<%= "PHONE".equals(findType) ? "checked" : "" %>>
					...
					<label for="findTypeEmail" class="find-id-label">
						...
						<input
							type="radio" id="findTypeEmail" name="FIND_TYPE"
							value="EMAIL" class="find-id-radio"
							<%= "EMAIL".equals(findType) ? "checked" : "" %>>
...
<script type="text/javascript">
	(function () {
		...
		if (!findTypePhone || !findTypeEmail || !phoneRow ||
			!emailRow || !phoneInput || !emailInput) {
...
<script type="text/javascript">
	(function () {
		...
		const phoneInputs =
			document.querySelectorAll(".phone-auto-format");

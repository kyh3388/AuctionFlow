...
<%
	...
	String changePasswordMessageType =
		(String) request.getAttribute(
			"CHANGE_PASSWORD_MESSAGE_TYPE"
		);
	...
	<div class="mypage-layout">
		...
		<section class="mypage-content">
			...
			<div
				...
				class="change-password-message <%= escapeHtml(changePasswordMessageType) %>"
				aria-live="polite">

				<%= escapeHtml(changePasswordMessage) %>
			...
			<form
				...
				<div class="change-password-row">
					...
					<label
						...
						<span class="change-password-required">
							*
						</span>
					...
					<div class="change-password-field">
						...
						<p
							id="currentPasswordMessage"
							class="change-password-validation-message">
						</p>
				...
				<div class="change-password-row">
					...
					<div class="change-password-field">
						...
						<p id="newPasswordMessage" class="change-password-validation-message"></p>
					</div>
				</div>
				...
				<div class="change-password-button-area">
					...
					<a
						...
						class="change-password-button cancel">
					...
					<button
						...
						class="change-password-button submit">
...
<script>
	...
	document.addEventListener("DOMContentLoaded", function () {
		...
		const passwordChangeSuccess =
			<%= "success".equals(changePasswordMessageType) %>;

		/*
		 * 변경:
		 * 비밀번호 변경 성공 시 팝업을 표시한 뒤
		 * 메인 화면으로 이동한다.
		 */
		if (passwordChangeSuccess) {
			...
			window.location.replace(
				"${pageContext.request.contextPath}/api/auctionFlow/main"
			);
		...
		const newPasswordConfirmMessage =
			document.getElementById(
		...
		function clearResultMessage() {
			...
			changePasswordMessage.classList.remove(
				"success",
				"error"
			);
		}

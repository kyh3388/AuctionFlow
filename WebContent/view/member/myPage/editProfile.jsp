...
<head>
	...
	<link
		rel="stylesheet"
		href="${pageContext.request.contextPath}/static/css/common/footer.css">
	<link
		rel="stylesheet"
		href="${pageContext.request.contextPath}/static/css/member/myPage/common/sidebar.css">
	<link
		rel="stylesheet"
		href="${pageContext.request.contextPath}/static/css/member/myPage/editProfile.css">
</head>
		...
		<section class="mypage-content">
			...
			<div class="mypage-content-header">
				...
				%>
					...
					<p class="mypage-page-description">
						회원정보 수정을 위해 본인 확인이 필요합니다.
						회원님의 비밀번호를 다시 한번 입력해 주세요.
					</p>
			...
			%>
				...
				<div class="edit-profile-password-panel">
					...
					<div class="edit-profile-password-guide">
						...
						<strong class="edit-profile-password-guide-title">
							회원정보를 안전하게 보호합니다.
						</strong>

						<p class="edit-profile-password-guide-text">
							회원정보 수정을 위해 현재 비밀번호를 입력해 주세요.
						</p>
					...
					<form
						...
						<div class="edit-profile-password-row">
							...
							<label
								for="currentPassword"
								class="edit-profile-password-label">
						...
						<div class="edit-profile-button-area">
							...
							<a
								href="${pageContext.request.contextPath}/api/auctionFlow/member/myPage/registerAuctionHistory"
								class="edit-profile-button cancel">
							...
							<button
								...
								class="edit-profile-button submit">
			...
			%>
				...
				<div class="edit-profile-panel">
					...
					<div class="edit-profile-required-guide">
						...
						<p id="editProfileMessage" class="edit-profile-message <%= escapeHtml(editProfileMessageType) %>" aria-live="polite">

							<%= escapeHtml(editProfileMessage) %>
						</p>

						<span class="edit-profile-required-text">
					...
					<form
						action="${pageContext.request.contextPath}/api/auctionFlow/member/myPage/editProfileProcess"
						method="post"
						id="editProfileForm"
						...
						<div class="edit-profile-row">
							...
							<div class="edit-profile-field">
								...
								<input
									type="text"
									id="memberId"
									class="edit-profile-input readonly"
									value="<%= escapeHtml(memberId) %>"
									readonly
									aria-readonly="true">
						...
						<div class="edit-profile-row">
							...
							<div class="edit-profile-field">
								...
								<!-- 변경: 이름을 수정 가능한 필수 입력값으로 변경 -->
								<input
									type="text"
									id="memberName"
									name="M_NAME"
									class="edit-profile-input"
									value="<%= escapeHtml(memberName) %>"
						...
						<div class="edit-profile-row">
							...
							<div class="edit-profile-field">
								...
								<input
									...
									name="M_PHONE_NUMBER"
									class="edit-profile-input"
									value="<%= escapeHtml(memberPhoneNumber) %>"
						...
						<div class="edit-profile-row">
							...
							<label
								...
								<span class="edit-profile-required">
									*
								</span>
							...
							<div class="edit-profile-field">
								...
								<input
									...
									name="M_ADDRESS"
									class="edit-profile-input"
									value="<%= escapeHtml(memberAddress) %>"
									placeholder="주소를 입력해 주세요."
									autocomplete="street-address"
									required>

								<p
									id="memberAddressMessage"
									class="edit-profile-validation-message">
								</p>
